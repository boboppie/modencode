...
data = { "organisms" : [ { "categories" : [ { "category_title" : "Chromatin structure",
              "experiments" : [ { "experiment_title" : "Genome-wide Chromatin Profiling",
                    "labs" : [ "Kamran Ahmad",
                        "Steven Henikoff"
                      ],
                    "pi" : "Steven Henikoff"
            ...
            { "category_title" : "Copy Number Variation",
              "experiments" : [ { "experiment_title" : "CGH drosophila cell lines",
            ...
            { "category_title" : "Gene Structure",
              "experiments" : [ { "experiment_title" : "RT-PCR",
                    "labs" : [ "Michael Brent" ],
                    "pi" : "Sue Celniker"
                  },
            ...
            { "category_title" : "Histone modification and replacement",
              "experiments" : [ { "experiment_title" : "HMM Prediction of D. melanogaster Chromatin States",
                    "labs" : [ "Gary Karpen" ],
                    "pi" : "Gary Karpen"
                  },
            ...
            { "category_title" : "Metadata only",
              "experiments" : [ { "experiment_title" : "RNA made in Bloomington",
                    "labs" : [ "Peter Cherbas",
                        "Tom Gingeras"
                      ],
                    "pi" : "Sue Celniker"
            ...
            { "category_title" : "Other chromatin binding sites",
              "experiments" : [ { "experiment_title" : "Genomic Distributions of non-Histone Chromosomal Proteins in D. melanogaster",
                    "labs" : [ "Gary Karpen",
                        "Mitzi Kuroda",
                        "Sarah Elgin",
                        "Vincent Pirrotta"
            ...
            { "category_title" : "RNA expression profiling",
              "experiments" : [ { "experiment_title" : "Transcriptional Profiling of additional Drosophila species with RNA-Seq",
                    "labs" : [ "Brian Oliver" ],
                    "pi" : "Brian Oliver"
                  },
            ...
            { "category_title" : "Replication",
              "experiments" : [ { "experiment_title" : "Replication Timing Characterization",
                    "labs" : [ "David MacAlpine" ],
                    "pi" : "David MacAlpine"
                  },
            ...
            { "category_title" : "TF binding sites",
              "experiments" : [ { "experiment_title" : "Chromatin Binding Site Mapping",
                    "labs" : [ "Kevin White" ],
                    "pi" : "Kevin White"
                  },
      ...
      { "categories" : [ { "category_title" : "Chromatin structure",
